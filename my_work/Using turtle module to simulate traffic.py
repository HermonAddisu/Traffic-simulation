...
LIGHT_DURATION = 7000  # Duration for each light in milliseconds
...
class Vehicle:
    def __init__(self):
        ...
        self.speed = random.uniform(2, 4)  # Increased speed
    ...
    def update(self):
        if self.running:
            ...
            for vehicle in self.vehicles:
                vehicle.move()  # Move vehicles regardless of light state
            self.traffic_light.change_light()
            screen.ontimer(self.update, LIGHT_DURATION)  # Update every light duration
